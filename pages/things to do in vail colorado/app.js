...
const App = () => {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "VAIL LOCAL")), /*#__PURE__*/React.createElement("div", {
    className: "hidden md:flex gap-8 items-center font-bold text-sm"
  }, /*#__PURE__*/React.createElement("a", {
    href: "#hacks",
    className: scrolled ? 'text-slate-600' : 'text-white'
  }, "Budget Hacks"), /*#__PURE__*/React.createElement("a", {
    href: "#activities",
    className: scrolled ? 'text-slate-600' : 'text-white'
  }, "Free Stuff"), /*#__PURE__*/React.createElement("button", {
    className: "bg-blue-600 text-white px-5 py-2 rounded-full shadow-lg"
  }, "Plan Your Move")))), /*#__PURE__*/React.createElement("section", {
    className: "relative h-[80vh] flex items-center justify-center text-center overflow-hidden"
  }, /*#__PURE__*/React.createElement("div", {
    className: "absolute inset-0 z-0"
  }, /*#__PURE__*/React.createElement("img", {
    src: "https://images.unsplash.com/photo-1486496146582-9ffcd0b2b2b7?auto=format&fit=crop&q=80&w=2000",
  ...
  }, "Vail for the ", /*#__PURE__*/React.createElement("span", {
    className: "text-emerald-400"
  }, "Rest of Us")), /*#__PURE__*/React.createElement("p", {
    className: "text-lg md:text-xl text-slate-200 max-w-2xl mx-auto mb-10 font-medium"
  }, "Skip the $20 hot cocoa. Discover how to hike, play, and explore Vail for free (or close to it)."), /*#__PURE__*/React.createElement("div", {
    className: "flex flex-col sm:flex-row gap-4 justify-center"
  }, /*#__PURE__*/React.createElement("a", {
    href: "#activities",
    className: "bg-emerald-500 text-white px-8 py-4 rounded-2xl font-black hover:bg-emerald-600 transition-all flex items-center justify-center gap-2"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "search",
    className: "w-5 h-5"
  }), " Find Free Activities")))), /*#__PURE__*/React.createElement("section", {
    id: "hacks",
    className: "relative z-20 -mt-20 max-w-6xl mx-auto px-6 mb-24"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Free Bus Hub"), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-slate-500 mt-1 uppercase font-bold tracking-widest leading-none"
  }, "Save $400/week in parking"))), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-4 items-start"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-black text-slate-900"
  }, "Grocery Run"), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-slate-500 mt-1 uppercase font-bold tracking-widest leading-none"
  }, "City Market > Resort Dining"))), /*#__PURE__*/React.createElement("div", {
    className: "flex gap-4 items-start"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-black text-slate-900"
  }, "Donation Culture"), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-slate-500 mt-1 uppercase font-bold tracking-widest leading-none"
  }, "Free museums & parks"))))), /*#__PURE__*/React.createElement("section", {
    id: "activities",
  ...
  }, "Zero Dollar"), " List"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-500 font-bold"
  }, "Curated experiences that don't require a credit card swipe."), /*#__PURE__*/React.createElement("div", {
    className: "inline-flex bg-slate-200/50 p-1.5 rounded-2xl mt-8"
  }, ['free', 'low-cost', 'all'].map(cat => /*#__PURE__*/React.createElement("button", {
    key: cat,
  ...
  }, filteredActivities.map(activity => /*#__PURE__*/React.createElement("div", {
    key: activity.id,
    className: "group bg-white rounded-[2rem] overflow-hidden border border-slate-100 transition-all hover:shadow-2xl card-hover flex flex-col h-full"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, activity.tag)), /*#__PURE__*/React.createElement("div", {
    ...
    name: activity.category === 'free' ? "smile" : "dollar-sign"
  }))), /*#__PURE__*/React.createElement("div", {
  ...
  }, activity.highlights.map((h, i) => /*#__PURE__*/React.createElement("div", {
    key: i,
  ...
  }, "How to get there")))))), /*#__PURE__*/React.createElement("section", {
    id: "conservation",
    className: "py-24 bg-slate-900 text-white overflow-hidden text-center md:text-left"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    name: "shield-check",
    className: "w-4 h-4"
  }), " Rangers Legacy Stewardship"), /*#__PURE__*/React.createElement("h2", {
    className: "text-4xl md:text-6xl font-black mb-8 tracking-tighter"
  }, "Support Nature for ", /*#__PURE__*/React.createElement("span", {
    className: "text-blue-400"
  }, "Free")), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-400 text-lg mb-10 leading-relaxed max-w-xl"
  }, "Stewardship doesn't cost a dime. As part of the **Rangers Legacy** community, we invite you to hike with purpose. Observe, stay on trails, and keep our wildlife corridors clean."), /*#__PURE__*/React.createElement("div", {
  ...
  }, "Citizen Science"), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-slate-500 leading-relaxed font-medium"
  }, "Use free apps to log wildlife sightings and help our board monitor herds.")), /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-bold mb-1"
  }, "Path Protection"), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-slate-500 leading-relaxed font-medium"
  }, "Staying on trail prevents erosion that costs millions in annual repair.")))), /*#__PURE__*/React.createElement("div", {
    className: "relative flex justify-center lg:justify-end"
  }, /*#__PURE__*/React.createElement("div", {
    className: "w-full max-w-md aspect-[4/5] rounded-[3rem] overflow-hidden border border-white/10 relative shadow-2xl"
  }, /*#__PURE__*/React.createElement("img", {
    src: "https://images.unsplash.com/photo-1544198365-f5d60b6d8190?auto=format&fit=crop&q=80&w=1000",
  ...
  }, "A Message from the Board"), /*#__PURE__*/React.createElement("p", {
    className: "text-sm font-medium italic text-slate-200 leading-relaxed"
  }, "\"The best things in Vail are wild and free. Help us keep it that way through smart thinking.\"")))))))), /*#__PURE__*/React.createElement("section", {
    className: "bg-white border-t border-slate-100 py-16 text-center"
  }, /*#__PURE__*/React.createElement("div", {
    className: "max-w-7xl mx-auto px-6"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "mountain",
    className: "w-10 h-10 text-blue-600 mb-8 mx-auto"
  }), /*#__PURE__*/React.createElement("h3", {
    className: "text-2xl font-black tracking-tighter mb-4 uppercase"
  }, "Vail Experience Hub"), /*#__PURE__*/React.createElement("p", {
    className: "text-slate-400 text-xs font-bold uppercase tracking-widest mb-12"
  }, "Built for Locals, Travelers, and the Wild."), /*#__PURE__*/React.createElement("div", {
    className: "flex justify-center gap-10 text-[10px] font-black text-slate-400 uppercase tracking-widest"
  }, /*#__PURE__*/React.createElement("a", {
    href: "#",
    className: "hover:text-blue-600 transition-colors"
  }, "Hacks"), /*#__PURE__*/React.createElement("a", {
    href: "#",
    className: "hover:text-blue-600 transition-colors"
  }, "Free Parks"), /*#__PURE__*/React.createElement("a", {
    href: "#",
    className: "hover:text-blue-600 transition-colors"
  }, "Contact")))));
};
